...
var Dajaxice = {
    ...
    loadStats: function(callback_function, argv, custom_settings){
        return Dajaxice.call('assignments.loadStats', 'POST', callback_function, argv, custom_settings);
    },

    getfilesUploaded: function(callback_function, argv, custom_settings){
        return Dajaxice.call('assignments.getfilesUploaded', 'POST', callback_function, argv, custom_settings);
    },

    loadFile: function(callback_function, argv, custom_settings){
        return Dajaxice.call('assignments.loadFile', 'POST', callback_function, argv, custom_settings);
    }
