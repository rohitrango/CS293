        ...
        var convertToHtml = function(){
            ...
            if (!/markdown/.test(wmd_options.output_format.toLowerCase())) {
                if (markdownConverter) {
                    ...
                    MathJax.Hub.Queue(["Typeset",MathJax.Hub, inputBox]);
...
//
    // Escaping mathjax delimeters
    // text = text.split("\\(").join("<div id='inline'>");
    // text = text.split("\\)").join("</div>");
    // text = text.split("$$").join("<div id='block'>");
    ...
    // Restoring mathjax delimeters
    // text = text.split("<div id='inline'>").join("\\(");
    // text = text.split("</div>").join("\\)");
    // text = text.split("<div id='block'>").join("$$");
